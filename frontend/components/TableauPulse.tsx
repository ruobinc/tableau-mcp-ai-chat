...
export default function TableauPulse({ username = "default-user" }: TableauPulseProps) {
      ...
      <Box sx={{
        ...
        >
          ...
          <iframe
            ...
            onLoad={() => {
              // Here you would typically initialize the Tableau Pulse embedding
              console.log('Tableau Pulse container ready for user:', username);
            }}
          />
